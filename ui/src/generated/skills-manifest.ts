...
const _manifestData = {
  "skills": [
    ...
    },
    {
      ...
      "iconType": "svg",
      "description": "将主题、素材、草稿、Markdown 或正文先整理为可审阅的公众号发布源稿，固定生成 title、summary、cover_prompt、markdown；确认后按内置多主题生成微信兼容内联样式 HTML，包含严格论文主题，默认不生成中间文件，用户明确要求时可落盘 final.html 或 source.md + final.html。",
